...
```{r}
return100K50 <- markovGame(100000, 100, 5000000, 0.50)
print(return100K50)

expect50 <- as.vector(replicate(100, markovGame(100000, 100, 5000000, 0.50)))
print(expect50)
mean(expect50)
```
...
```{r}
expectChanged <- as.vector(replicate(100, markovGame(100000, 100, 5000000, starting_p = 0.50, increment = 0.03)))
print(expectChanged)
mean(expectChanged)
```
